          ...
          children: [
            ...
            Padding(
              ...
              child: SegmentedButton<String>(
                ...
                segments: const [
                  ButtonSegment<String>(value: 'all', label: Text('所有标签')),
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                subtitle: Text(
                  isCurrentlyDefault
                      ? '切换到笔记标签时不再打开"$folderName"'
                      : '切换到笔记标签时始终打开"$folderName"',
                ),
                onTap: () async {
      ...
      children: [
        ...
        if (currentTab == 1 || currentTab == 2)
          ListTile(
            ...
            title: Text('管理文件夹', style: theme.textTheme.bodyMedium),
            onTap: () {
              Navigator.of(context).pop();
        ...
        ListTile(
          ...
          title: Text('设置', style: theme.textTheme.bodyMedium),
          onTap: () {
            Navigator.of(context).pop();
            onClearVaultSelection();
    ...
    return Column(
      children: [
        ListTile(
          ...
          title: Text('日历', style: theme.textTheme.bodyMedium),
          trailing: Icon(
