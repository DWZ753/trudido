            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SpacingGap.gapV16,
                  Text('任务标题', style: theme.textTheme.titleLarge),
                  SpacingGap.gapV8,
                  Text(
                    '这是你的任务和笔记在当前字体大小设置下的显示效果。',
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      _ignoreSystem
                          ? '自定义字体大小（90% - 130%）会覆盖你的设备设置，类似于 Reddit 的字体大小控制。'
                          : '开启"忽略系统字体大小"以独立于设备设置来自定义应用的文字大小。',
                      style: theme.textTheme.bodySmall?.copyWith(
