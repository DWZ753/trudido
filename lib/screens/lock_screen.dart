...
class _PinSetupScreenState extends State<PinSetupScreen> {
  ...
  String get _title {
    ...
    if (_isConfirming) return '确认PIN码';
    return widget.isChangingPin ? '输入新PIN码' : '创建PIN码';
  }

  String get _subtitle {
    if (widget.subtitle != null && !_isConfirming) return widget.subtitle!;
    if (_isConfirming) return '再次输入相同的PIN码';
    return '输入4-6位PIN码';
  }
