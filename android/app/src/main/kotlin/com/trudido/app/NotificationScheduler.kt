...
object NotificationScheduler {
    ...
    fun updateGroupSummary(context: Context) {
        ...
        val lines = active.take(5).map { it.notification.extras.getString(Notification.EXTRA_TITLE) ?: "任务" }
        val summary = NotificationCompat.Builder(context, CHANNEL_LOW_ID)
            .setSmallIcon(context.applicationInfo.icon)
            .setContentTitle("${active.size} 个任务提醒")
